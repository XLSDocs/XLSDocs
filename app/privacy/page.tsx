...
const TOC: LegalTocItem[] = [
  ...
  { id: 'who-we-share-data-with', label: 'Who we share data with' },
  { id: 'cookies', label: 'Cookies' },
  { id: 'your-options', label: 'Your options' },
        ...
        <div className="mx-auto flex max-w-4xl gap-12 px-6 py-16">
          ...
          <div className="min-w-0 max-w-2xl flex-1">
            ...
            <article className="prose mt-10">
              <h2 id="the-short-version" className="scroll-mt-24">The short version</h2>
              <p>
              ...
              <h2 id="what-we-collect" className="scroll-mt-24">What we collect</h2>
              <h3>Analytics</h3>
              <p>
              ...
              <p>
                ...
                counted per IP address for up to one day, then automatically
                discarded. This is used only to enforce a fair usage limit,
                never to build a profile of you.
              </p>

              <h3>AI Formula Builder, Quick Fix, and Ask AI prompts</h3>
              <p>
                What you type into any of the three AI tools is sent to
                Anthropic's Claude API to generate a response. xlsdocs.com
                doesn't store your prompts or the formulas generated — once
                the response is sent back to your browser, nothing is
                retained server-side. Recent builds shown in the Formula
                Builder sidebar live only in your browser's memory for that
                session, not on any server.
              </p>

              <h3>Subscription status, if you subscribe</h3>
              <p>
                If you subscribe to the paid tier, a signed cookie recognizes
                your subscription so you're not shown the free-tier limit —
                it contains your Stripe customer ID, nothing else, and can't
                be read or modified outside our server. A record of your
                subscription status (active, canceled, etc.) is kept so
                access can be correctly granted or revoked. xlsdocs.com never
                receives or stores your card number or billing details —
                that's handled entirely by Stripe's own hosted checkout.
              </p>

              <h2 id="who-we-share-data-with" className="scroll-mt-24">Who we share data with</h2>
              <p>
              ...
              <ul>
                ...
                <li>
                  ...
                  the AI Formula Builder, Quick Fix, or Ask AI, in order to
                  generate a response.
                </li>
                <li>
              ...
              <h2 id="cookies" className="scroll-mt-24">Cookies</h2>
              <p>
              ...
              <h2 id="your-options" className="scroll-mt-24">Your options</h2>
              <p>
              ...
              <h2 id="changes-to-this-policy" className="scroll-mt-24">Changes to this policy</h2>
              <p>
